<script lang="ts">
	import PokemonCard from "$lib/components/complex-component/components/pokemon-card.svelte";
	import { getPokemonList } from "$lib/components/complex-component/lib/pokemon.js";
</script>
